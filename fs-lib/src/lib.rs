...
lazy_static::lazy_static! {
    ...
    pub static ref EXECUTABLE_PATTERNS: HashMap<Platform, Vec<PatternItem>> = {
        ...
        items.insert(Platform::Steam, vec![
            ...
            // PatternItem {
            //     patch_type: PatchType::CorruptFile,
            //     find: vec![0x0F, 0x84, 0x10, 0x17, 0x00, 0x00, 0x41, 0x8B, 0xDE, 0x48],
            //     replace: vec![0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x41, 0x8B, 0xDE, 0x48]
            // },
            ...
            // PatternItem {
            //     patch_type: PatchType::CorruptFile,
            //     find: vec![0x0F, 0x84, 0xBA, 0x17, 0x00, 0x00, 0x41, 0x8B, 0xDE, 0x48],
            //     replace: vec![0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x41, 0x8B, 0xDE, 0x48]
            // },
            ...
            // PatternItem {
            //     patch_type: PatchType::CorruptFile,
            //     find: vec![0x0F, 0x84, 0xFA, 0x18, 0x00, 0x00, 0x41, 0x8B, 0xFF, 0x48],
            //     replace: vec![0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x41, 0x8B, 0xFF, 0x48]
            // },

            // Version 1.21.1.0
            PatternItem {
                patch_type: PatchType::CorruptFile,
                find: vec![0x0F, 0x84, 0xDF, 0x16, 0x00, 0x00, 0x45, 0x8B, 0xFD, 0x48],
                replace: vec![0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x45, 0x8B, 0xFD, 0x48],
            },
        ]);
