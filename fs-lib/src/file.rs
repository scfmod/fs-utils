...
pub trait FileExtension {
    fn read_bytes(&mut self, offset: usize, length: usize) -> Result<Vec<u8>>;
    fn read_u8(&mut self, offset: usize) -> Result<u8>;
    fn read_u16(&mut self, offset: usize) -> Result<u16>;
    fn read_u32(&mut self, offset: usize) -> Result<u32>;
    fn read_string(&mut self, offset: usize, length: usize) -> Result<String>;
}
